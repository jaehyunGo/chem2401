...
# - 4089개의 샘플이 0으로 예측되고 실제로 0입니다. (True Negative)
# - 1476개의 샘플이 1로 예측되고 실제로 0입니다. (False Positive)
# - 242개의 샘플이 0으로 예측되고 실제로 1입니다. (False Negative)
# - 5323개의 샘플이 1로 예측되고 실제로 1입니다. (True Positive)