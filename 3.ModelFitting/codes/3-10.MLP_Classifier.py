...
# - 5504개의 샘플이 0으로 예측되고 실제로 0입니다. (True Negative)
# - 61개의 샘플이 1로 예측되고 실제로 0입니다. (False Positive)
# - 14개의 샘플이 0으로 예측되고 실제로 1입니다. (False Negative)
# - 5551개의 샘플이 1로 예측되고 실제로 1입니다. (True Positive)
